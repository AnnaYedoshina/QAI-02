...
/**
 * Класс, содержащий End-to-End тест для веб-приложения saucedemo.com.
 */
@Feature("End-to-End Сценарий Покупки")
public class E2ETest extends BaseTest {

    /**
     * Единый e2e-тест, покрывающий полный пользовательский сценарий:
     * 1. Логин.
     * 2. Добавление товара в корзину.
     * 3. Удаление товара из корзины.
     * 4. Возврат к каталогу.
     * 5. Добавление другого товара.
     * 6. Оформление и завершение заказа.
     */
    @Test
